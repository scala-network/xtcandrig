    ...
    m_listener(listener)
{
    uint8_t hash[200];
//    char userId[65] = { 0 };
    const char *user = "Se3dRf8ZTUXKYivaTFU4KYczPcmMcwPZWEQ5HZmj3RRviFJ3w1mNhtgCWkn6VsnQcMBX1hyCUjZVuSo8X7yJTSYj1joP84WoT";

//    keccak(reinterpret_cast<const uint8_t *>(user), static_cast<int>(strlen(user)), hash, sizeof(hash));
//    Job::toHex(hash, 32, userId);

    Url *url = new Url("stratum+tcp//:stratum.xtlpool.com", 8888, user, nullptr, false, true);
