...
#   endif
    ...
    Log::i()->text(Options::i()->colors() ? "\x1B[01;32m * \x1B[01;37mVERSIONS:     \x1B[01;36mXTLANDRIG/%s\x1B[01;37m libuv/%s%s" : " * VERSIONS:     XTLANDRIG/%s libuv/%s%s",
...
static void print_threads()
{
    ...
    Log::i()->text(Options::i()->colors() ? "\x1B[01;32m * \x1B[01;37mTHREADS:      \x1B[01;36m%d\x1B[01;37m, av=%d, %sdonate=%d%%%s" : " * THREADS:      %d, av=%d, %sdonate=%d%%%s",
                   Options::i()->threads(),
...
static void print_algo(){
    Log::i()->text(Options::i()->colors() ? "\x1B[01;32m * \x1B[01;37mALGORITHM:    \x1B[01;37m%s" : " * ALGORITHM:      %s",
                   Options::i()->algoName());
