...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../src $(LOCAL_PATH)/../deps/libuv/include $(LOCAL_PATH)/../deps


LOCAL_CPPFLAGS += -pthread  -frtti -std=c++11  -Wall -fno-exceptions -fno-rtti -Wno-missing-braces
LOCAL_CFLAGS   += -Ofast -funroll-loops -fmerge-all-constants -flax-vector-conversions -g
LOCAL_CPPFLAGS += -Ofast -funroll-loops -fmerge-all-constants -flax-vector-conversions -g
